...
Item.create!(
  seller_id: '2',
  description: 'CANON SURE SHOT Super mint canon af35mii with box and polaroid side bag! Previous owner stored it for 19 years This is hard to let go. I love this camera but im going full digital Takes 35mm film Looks good as new! Shutter works perfectly, no battery corrosion Battery works perfectly Comes with a 40mm 1.8 lens Great point and shoot camera overall 10/10 supreme vintage condition ACCEPTING REASONABLE OFFERS TAGS: canon sureshot af35m af35ML af35mii 35mm film camera sony strap bag shoulderbag sidebag camerabag macro zoom 50mm photography photo polaroid retro vintage spring summer throwback 80s 90s y2k 2000 depop depopvintage depopfamous depoponly NOT nikon minolta olympus',
  price: '150.00',
  sold: 'false'
)
